...
/**
 * Prediction bet okup form
 */
class PredictionBetOkupForm extends Model
{
    public $username;
    public $points;
    public $userBet;
     ...
     * @throws Exception
     */
    public function predictionBetOkup()
    {
        if ($this->validate()) {
            ...
            if (!$userBet) {
                ...
                if ($prediction->status === Prediction::STATUS_ACTIVE) {
                    ...
                    $userBet->prediction_type = PredictionBet::TYPE_OKUP;
                    ...
                    $prediction->points_okup = $prediction->points_okup + $this->points;
